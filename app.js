...
const AppData = {
  ...
  tasks: [
    ...
    {"task_id": 2, "title": "Customer Survey", "description": "Ask feedback from customers", "date": "2025-07-03", "time": "15:00", "duration": 30, "recurrence": "Daily", "priority": "Low", "assigned_to": 4, "assigned_by": 2, "assignment_type": "auto", "status": "in_progress"},
    {"task_id": 3, "title": "Restock Shelves", "description": "Restock all empty shelves", "date": "2025-07-03", "time": "09:00", "duration": 90, "recurrence": "None", "priority": "High", "assigned_to": 5, "assigned_by": 1, "assignment_type": "manual", "status": "completed"}
  ],
  workShifts: [
